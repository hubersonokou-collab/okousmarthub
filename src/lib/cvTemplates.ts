...
export const CV_TEMPLATES: CVTemplate[] = [
    ...
    // FRANCE Templates
    {
        ...
        sections_config: ['personal_info', 'photo', 'profile', 'experience', 'education', 'competences', 'languages'],
        is_active: true,
        is_premium: false,
        preview_image_url: '/templates/thumbnails/france-europass.jpg',
        layout: 'single_column',
    ...
    },
    {
        ...
        sections_config: ['personal_info', 'photo', 'about', 'experience', 'education', 'competences', 'portfolio'],
        is_active: true,
        is_premium: true,
        preview_image_url: '/templates/thumbnails/france-creative.jpg',
        layout: 'two_column',
